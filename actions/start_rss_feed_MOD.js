module.exports = {
	...
	<div style="padding-top: 8px;">
		<div style="float:left">
			<u>Note:</u><b>This action will not stop watching the feed until bot restarts or using Stop RSS Feed Watcher action!</b>
		</div><br><br>
		<div style="float:left">
			<b>The next actions will be called on feed update!</b>
		</div><br>
		<div>
			Local/Web URL:<br>
